          ...
          <motion.div
            ...
            <Row className="ok">
              <Col >
                ...
                <div className="front btn btn-danger justify-content-center align-items-center rippleEffect" onClick={doBook}>
                  <span className="ripple">Book Pickup</span>
                  
                </div>
                {/* <div className="conta ">
                <span className="bndesign">Book Now</span>
                <span className="bndesign">Book Now</span>
                </div> */}
              ...
              <Col >
                {/* btn2 */}
                {/* <div className="conta">
                <span className="bndesign">Our Services</span>
                <span className="bndesign">Our Services</span>
                </div> */}
